    ...
    public partial class AddUserJobTitle : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                UPDATE ""Users"" u
                SET ""JobTitle"" = CASE r.""Type""
                    WHEN 3 THEN 'Microbiology Analyst'
                    WHEN 1 THEN 'Microbiology Section Head'
                    WHEN 2 THEN 'Quality Reviewer'
                    WHEN 0 THEN 'System Administrator'
                    ELSE 'Microbiology Staff'
                END
                FROM ""Roles"" r
                WHERE u.""RoleId"" = r.""Id"" AND u.""JobTitle"" IS NULL;
            ");
