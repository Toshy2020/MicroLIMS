...
const ReviewWorkflowEventType = ["Submitted for Review", "Review Completed", "Submitted for Approval", "Approval Decision Made", "Sample Voided", "Sample Corrected"];
...
const SampleStatus = ["Received", "In Testing", "Under Review", "Under Approval", "Approved", "Rejected", "Retest Requested", "Cancelled", "Voided"];
const SignatureMeaning = ["Reviewed", "Approved", "Rejected", "Retest Requested", "Investigation Ordered", "Preparation Steps Confirmed as Configured", "Sample Corrected", "Sample Voided"];
